...
public final class ItemBlockedSmsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ItemBlockedSmsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemBlockedSmsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_blocked_sms, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemBlockedSmsBinding bind(@NonNull View rootView) {
